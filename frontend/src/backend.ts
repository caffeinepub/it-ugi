...
export class Backend implements backendInterface {
    ...
    async filterAssetsByType(arg0: string): Promise<Array<Asset>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterAssetsByType(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCreativePackages(): Promise<Array<CreativePackage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllCreativePackages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCreativePackage(arg0: string): Promise<CreativePackage> {
        if (this.processError) {
            try {
                const result = await this.actor.getCreativePackage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveAsset(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAsset(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCreativePackage(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<Asset>, arg6: Array<Asset>, arg7: Array<Asset>, arg8: Array<Asset>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCreativePackage(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
